...
## Task description
We are given a file with bitmasks and integers to write to memory-positions (initialized as all zero). Our task is to find out the value of the sum of the integers in memory after applying all instructions from the file. 
